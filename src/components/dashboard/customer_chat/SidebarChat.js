                            ...
                            <Tab key="contact" title="Contact">
                                {listCustomer.map(data =>
                                    <div onClick={() => handleSelect(data)} className='flex flex-col gap-2' key={data.id}>
                                        <div className={`${data.nohp === customer[0]?.nohp ? 'bg-secondary text-secondary-foreground' : ''} flex flex-row gap-4 items-center p-2 hover:bg-primary-100 hover:text-black cursor-pointer`}>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <div className='text-sm'>buram</div>
                                            </div>
                                        </div>
                                    </div>
                                )}
