...
const INITIAL_VISIBLE_COLUMNS = ["title", "lokasi", "path", "actions"];

export default function TabelMenu() {
  ...
  const columns = [
    ...
    { uid: "lokasi", name: "Lokasi", sortable: true },
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-small">Total {menus.length} menus</span>
  ...
  return (
    <>
      <div className='text-2xl pb-3'>Menu</div>
      <Table
        isStriped
      ...
      >
        ...
        <TableBody emptyContent={"Tidak ada data submenu."} items={sortedItems}>
          {(item) => (
