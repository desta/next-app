...
const INITIAL_VISIBLE_COLUMNS = ["title", "menu", "path", "actions"];

export default function TabelSubMenu() {
  ...
  const menus = useSelector((state) => state.SubMenu.data);
  ...
  const columns = [
    ...
    { uid: "menu", name: "Parent", sortable: true },
    { uid: "path", name: "Path", sortable: true },
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-small">Total {menus.length} submenus</span>
  ...
  return (
    <>
      <div className='text-2xl py-3'>Submenu</div>
      <Table
        isStriped
      ...
      >
        ...
        <TableBody emptyContent={"Tidak ada data menu."} items={sortedItems}>
          {(item) => (
