...
export default function TabelCustomers() {
  ...
  const columns = [
    { uid: "perusahaan", name: "Perusahaan", sortable: true },
    { uid: "pic", name: "PIC", sortable: true },
    { uid: "alamat", name: "Alamat" },
    { uid: "nohp", name: "No HP" },
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredUsers = filteredUsers.filter((idx) =>
        idx.perusahaan.toLowerCase().includes(filterValue.toLowerCase()),
      );
    }
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center pb-4">
          <span className="text-small">Total {customers.length} customers</span>
    ...
    <>
      ...
      <div ref={contentToPrint} className="area-print" media="print">
        ...
        >
          ...
          <TableBody emptyContent={"Tidak ada data customers."} items={sortedItems}>
            {(item) => (
