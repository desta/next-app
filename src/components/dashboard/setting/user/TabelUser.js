...
const INITIAL_VISIBLE_COLUMNS = ["username", "name", "akses", "actions"];
...
export default function TabelUser() {
  ...
  const columns = [
    ...
    { uid: "name", name: "Nama", sortable: true },
    { uid: "email", name: "Email" },
    { uid: "akses", name: "Akses", sortable: true },
    ...
    <>
      ...
      <div ref={contentToPrint} className="area-print" media="print">
        ...
        >
          ...
          <TableBody emptyContent={"Tidak ada data user"} items={sortedItems}>
            {(item) => (
